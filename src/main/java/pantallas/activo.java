...
import datos.NomactDao;
import datos.NomactDaoJDBC;
...
public class activo extends javax.swing.JFrame {
    ...
    public activo() throws SQLException {
        initComponents();
    ...
    private void agregarNombre() {
        cbActivo.addItem(txtNombre.getText());
    ...
    private void cargarTabla() throws SQLException {
        ...
        try {
            ...
            stmt = conn.prepareStatement("SELECT * FROM nomact ORDER BY nombre");
    ...
    private void agregarAccesorio() {
        ...
        try {
            ...
            NomactDao nomcompDao = new NomactDaoJDBC(conexion);
            NomactDTO nuevoNomact = new NomactDTO();
            String nombre = String.valueOf(cbActivo.getSelectedItem());
            nuevoNomact.setNombre(nombre);
            nuevoNomact.setAccesorio(txtAccesorio.getText());
            nomcompDao.insert(nuevoNomact);
            conexion.commit();
        } catch (SQLException ex) {
            ex.printStackTrace(System.out);
            try {
    ...
    private void llenarCuadrostexto() {
        ...
        cbActivo.setSelectedItem(String.valueOf(tabla1.getValueAt(fila, 1)));
        txtAccesorio.setText(String.valueOf(tabla1.getValueAt(fila, 2)));
    }
    ...
    private void eliminar() {
        ...
        try {
            ...
            NomactDao descripcionactDao = new NomactDaoJDBC(conexion);
            NomactDTO eliminarDescripcionact = new NomactDTO();
            int fila;
            fila = tabla1.getSelectedRow();
            int j = Integer.parseInt((String) tabla1.getValueAt(fila, 0));
            eliminarDescripcionact.setId(j);
            descripcionactDao.delete(eliminarDescripcionact);
            conexion.commit();
        } catch (SQLException ex) {
            ex.printStackTrace(System.out);
            try {
    ...
    private void modificar() {
        ...
        try {
            ...
            NomactDao nomcompDao = new NomactDaoJDBC(conexion);
            NomactDTO actualizarNomact = new NomactDTO();
            int fila;
            fila = tabla1.getSelectedRow();
            int j = Integer.parseInt((String) tabla1.getValueAt(fila, 0));
            actualizarNomact.setId(j);
            String nombre = String.valueOf(cbActivo.getSelectedItem());
            actualizarNomact.setNombre(nombre);
            actualizarNomact.setAccesorio(txtAccesorio.getText());
            nomcompDao.update(actualizarNomact);
            conexion.commit();
        } catch (SQLException ex) {
            ex.printStackTrace(System.out);
            try {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Registro accesorio de Activo");
        ...
        btnNombre.setText("Agregar Activo");
        ...
        cbActivo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--Seleccionar--" }));
        ...
        btnCaracteristica.setText("Agregar Accesorio");
        ...
        btnEliminar.setText("Eliminar accesorio");
        ...
        btnModificar.setText("Modificar accesorio");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtAccesorio)
                            .addComponent(txtNombre, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(cbActivo, javax.swing.GroupLayout.Alignment.TRAILING, 0, 207, Short.MAX_VALUE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(32, 32, 32)
                .addComponent(cbActivo, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(16, 16, 16)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtAccesorio, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTextArea1.setText("Accesorio por defecto:\n- Marca\n- Estado\n- Color\n- Material\n");
        jScrollPane2.setViewportView(jTextArea1);

        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 470, 330, 150));
...
//        me.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(activo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
