...
public class descripcionActivo extends javax.swing.JFrame {
    
    DefaultTableModel model;
    
    public descripcionActivo() throws SQLException {
        initComponents();
    ...
    private String[] tituloColumnas() throws SQLException {
        String[] titulos = {"Id", "Nombre", "Accesorio", "Descripcion"};
        return titulos;
    }
    ...
    private void cargarTabla() throws SQLException {
        ...
        ResultSet rs = null;
        try {
//            String filtro = txtIdActivo.getText();
            String filtro = registroActivo.txtId.getText();
            conn = Conexion.getConnection();
            stmt = conn.prepareStatement("SELECT id, nombre, accesorio, descripcion FROM descripcionactivo WHERE id_activo LIKE " + filtro + "");
    ...
    private void registrar() {
        ...
        try {
            ...
            DescripcionactDao activoDao = new DescripcionactDaoJDBC(conexion);
            DescripcionactDTO nuevaDescripcion = new DescripcionactDTO();
            nuevaDescripcion.setNombre(txtNombre.getText());
            String accesorio = String.valueOf(cbAccesorio.getSelectedItem());
            nuevaDescripcion.setAccesorio(accesorio);
            nuevaDescripcion.setDescripcion(txtDescripcion.getText());
            int idActivo = Integer.parseInt(txtIdActivo.getText());
            nuevaDescripcion.setId_activo(idActivo);
            activoDao.insert(nuevaDescripcion);
            conexion.commit();
    ...
    private void enviarDescripcion() {
        String accesorio = "";
        String descripcion = "";
        registroActivo.txtAccesorio.setText("");
        for (int i = 0; i < tabla1.getRowCount(); i++) {
            accesorio = String.valueOf(tabla1.getValueAt(i, 2));
            descripcion = String.valueOf(tabla1.getValueAt(i, 3));
            registroActivo.txtAccesorio.append(accesorio + ": " + descripcion + "\n");
        }
    }
    
    private void enviarDatos() {
        registroActivo.txtMarca.setText(txtMarca.getText());
        registroActivo.txtEstado.setText(txtEstado.getText());
        registroActivo.txtColor.setText(txtColor.getText());
        registroActivo.txtMaterial.setText(txtMaterial.getText());
        enviarDescripcion();
    }
    ...
    void llenarCuadrosTexto() {
        ...
        cbAccesorio.setSelectedItem(String.valueOf(tabla1.getValueAt(fila, 2)));
    ...
    private void eliminar() {
        ...
        try {
            ...
            DescripcionactDao activoDao = new DescripcionactDaoJDBC(conexion);
            DescripcionactDTO eliminarDescripcion = new DescripcionactDTO();
            int fila;
            fila = tabla1.getSelectedRow();
            int id = Integer.parseInt(String.valueOf(tabla1.getValueAt(fila, 0)));
            eliminarDescripcion.setId_activo(id);
            activoDao.delete(eliminarDescripcion);
            conexion.commit();
        } catch (SQLException ex) {
            ex.printStackTrace(System.out);
            try {
    ...
    private void modificar() {
        ...
        try {
            ...
            DescripcionactDao activoDao = new DescripcionactDaoJDBC(conexion);
            DescripcionactDTO modificarDescripcion = new DescripcionactDTO();
            int fila;
            fila = tabla1.getSelectedRow();
            int id = Integer.parseInt(String.valueOf(tabla1.getValueAt(fila, 0)));
            modificarDescripcion.setId_activo(id);
            modificarDescripcion.setNombre(txtNombre.getText());
            String accesorio = String.valueOf(cbAccesorio.getSelectedItem());
            modificarDescripcion.setAccesorio(accesorio);
            modificarDescripcion.setDescripcion(txtDescripcion.getText());
            int idActivo = Integer.parseInt(txtIdActivo.getText());
            modificarDescripcion.setId_activo(idActivo);
            activoDao.update(modificarDescripcion);
            conexion.commit();
        } catch (SQLException ex) {
            ex.printStackTrace(System.out);
            try {
    ...
    private void initComponents() {
        ...
        cbAccesorio = new javax.swing.JComboBox<>();
        ...
        jLabel1.setText("ID del activo:");

        txtIdActivo.setBackground(new java.awt.Color(218, 215, 205));
        txtIdActivo.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        jLabel2.setText("Registro Descripcion Activo");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            .addComponent(cbAccesorio, javax.swing.GroupLayout.PREFERRED_SIZE, 194, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(18, 18, 18)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(cbAccesorio, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
        ...
        txtMaterial.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(txtIdActivo, javax.swing.GroupLayout.PREFERRED_SIZE, 232, javax.swing.GroupLayout.PREFERRED_SIZE)))))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(txtIdActivo, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        enviarDatos();
        registroActivo.btnRegistrar.doClick();
        dispose();
    ...
    private void btnDescripcionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDescripcionActionPerformed
        ...
        try {
            ...
            Logger.getLogger(descripcionActivo.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnGuardarComponenteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarComponenteActionPerformed
        enviarDatos();
        registroActivo.btnGuardar.doClick();
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(descripcionActivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new descripcionActivo().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(descripcionActivo.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    public static javax.swing.JComboBox<String> cbAccesorio;
    ...
    public static javax.swing.JTextField txtIdActivo;
