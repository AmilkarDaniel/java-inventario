...
public class verActivo extends javax.swing.JFrame {

    DefaultTableModel model;

    public verActivo() throws SQLException {
        initComponents();
        ...
        btnRegistrosPersona.setEnabled(false);
    ...
    private String[] tituloColumnasActivo() throws SQLException {
    ...
    private void cargarTabla() throws SQLException {
        ...
        try {
            conn = Conexion.getConnection();
            stmt = conn.prepareStatement("SELECT id_activo, fkregistro, nombre, SUBSTRING(fecha, 1,10) AS fecha, marca, estado, color, material, accesorio, creador FROM activo ORDER BY fkregistro");
            rs = stmt.executeQuery();
            model = new DefaultTableModel(null, tituloColumnasActivo());
            while (rs.next()) {
    ...
    private void formatoTablaActivo() {
    ...
    public int existeActivoPersona(String nombre) throws SQLException {
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        conn = Conexion.getConnection();
...
//            PdfWriter.getInstance(documento, new FileOutputStream(ruta + "/Desktop/" + txtCodigo.getText().trim() + ".pdf"));
            ...
            try {
                ...
                float[] medidaCeldas = {0.35f, 0.65f, 0.65f, 0.65f, 0.65f, 0.55f, 0.65f, 0.65f, 0.65f};
    ...
    private void buscar() {
        ...
        if (cbBuscar.getSelectedIndex() == 0) {
            sql = "SELECT id_activo, fkregistro, nombre, SUBSTRING(fecha, 1,10) AS fecha, marca, estado, color, material, accesorio, creador FROM activo";
        } else {
            if (cbBuscar.getSelectedIndex() == 1) {
                sql = "SELECT id_activo, fkregistro, nombre, SUBSTRING(fecha, 1,10) AS fecha, marca, estado, color, material, accesorio, creador FROM activo WHERE id_activo = " + filtro + "";
            } else {
                if (cbBuscar.getSelectedIndex() == 2) {
                    sql = "SELECT id_activo, fkregistro, nombre, SUBSTRING(fecha, 1,10) AS fecha, marca, estado, color, material, accesorio, creador FROM activo WHERE fkregistro LIKE '%" + filtro + "%'";
                } else {
                    if (cbBuscar.getSelectedIndex() == 3) {
                        sql = "SELECT id_activo, fkregistro, nombre, SUBSTRING(fecha, 1,10) AS fecha, marca, estado, color, material, accesorio, creador FROM activo WHERE nombre LIKE '%" + filtro + "%'";
                    } else {
                        if (cbBuscar.getSelectedIndex() == 4) {
                            sql = "SELECT id_activo, fkregistro, nombre, SUBSTRING(fecha, 1,10) AS fecha, marca, estado, color, material, accesorio, creador FROM activo WHERE fecha LIKE '%" + filtro + "%'";
                        } else {
                            if (cbBuscar.getSelectedIndex() == 5) {
                                sql = "SELECT id_activo, fkregistro, nombre, SUBSTRING(fecha, 1,10) AS fecha, marca, estado, color, material, accesorio, creador FROM activo WHERE marca LIKE '%" + filtro + "%'";
                            } else {
                                if (cbBuscar.getSelectedIndex() == 6) {
                                    sql = "SELECT id_activo, fkregistro, nombre, SUBSTRING(fecha, 1,10) AS fecha, marca, estado, color, material, accesorio, creador FROM activo WHERE estado LIKE '%" + filtro + "%'";
                                } else {
                                    if (cbBuscar.getSelectedIndex() == 7) {
                                        sql = "SELECT id_activo, fkregistro, nombre, SUBSTRING(fecha, 1,10) AS fecha, marca, estado, color, material, accesorio, creador FROM activo WHERE color LIKE '%" + filtro + "%'";
                                    } else {
                                        if (cbBuscar.getSelectedIndex() == 8) {
                                            sql = "SELECT id_activo, fkregistro, nombre, SUBSTRING(fecha, 1,10) AS fecha, marca, estado, color, material, accesorio, creador FROM activo WHERE material LIKE '%" + filtro + "%'";
                                        } else {
                                            if (cbBuscar.getSelectedIndex() == 9) {
                                                sql = "SELECT id_activo, fkregistro, nombre, SUBSTRING(fecha, 1,10) AS fecha, marca, estado, color, material, accesorio, creador FROM activo WHERE accesorio LIKE '%" + filtro + "%'";
                                            } else {
                                                if (cbBuscar.getSelectedIndex() == 10) {
                                                    sql = "SELECT id_activo, fkregistro, nombre, SUBSTRING(fecha, 1,10) AS fecha, marca, estado, color, material, accesorio, creador FROM activo WHERE creador LIKE '%" + filtro + "%'";
                                                }
                                            }
                                        }
                                    }
    ...
    private void nombreActivos() {
        ...
        try {
            conn = Conexion.getConnection();
            stmt = conn.prepareStatement("SELECT DISTINCT nombre FROM activo");
            rs = stmt.executeQuery();
            String[] titulo = {"Nombre de Activos"};
    ...
    private void buscarActivoPersona() {
        String sql = "";
        String filtro = txtBuscarPersona.getText();
        String codigo = txtCodigo.getText();

        if (cbBuscarPersona.getSelectedIndex() == 1) {
            sql = "SELECT id_activo, fkregistro, nombre, SUBSTRING(fecha, 1,10) AS fecha, marca, estado, color, material, accesorio, creador FROM activo WHERE fkregistro IN (SELECT id FROM registro WHERE fkpersona LIKE '" + codigo + "') and id_activo LIKE " + filtro + "";
        } else {
            if (cbBuscarPersona.getSelectedIndex() == 2) {
                sql = "SELECT id_activo, fkregistro, nombre, SUBSTRING(fecha, 1,10) AS fecha, marca, estado, color, material, accesorio, creador FROM activo WHERE fkregistro IN (SELECT id FROM registro WHERE fkpersona LIKE '" + codigo + "') and nombre LIKE '%" + filtro + "%'";
            } else {
                if (cbBuscarPersona.getSelectedIndex() == 3) {
                    sql = "SELECT id_activo, fkregistro, nombre, SUBSTRING(fecha, 1,10) AS fecha, marca, estado, color, material, accesorio, creador FROM activo WHERE fkregistro IN (SELECT id FROM registro WHERE fkpersona LIKE '" + codigo + "') and fecha LIKE '%" + filtro + "%'";
                } else {
                    if (cbBuscarPersona.getSelectedIndex() == 4) {
                        sql = "SELECT id_activo, fkregistro, nombre, SUBSTRING(fecha, 1,10) AS fecha, marca, estado, color, material, accesorio, creador FROM activo WHERE fkregistro IN (SELECT id FROM registro WHERE fkpersona LIKE '" + codigo + "') and marca LIKE '%" + filtro + "%'";
                    } else {
                        if (cbBuscarPersona.getSelectedIndex() == 5) {
                            sql = "SELECT id_activo, fkregistro, nombre, SUBSTRING(fecha, 1,10) AS fecha, marca, estado, color, material, accesorio, creador FROM activo WHERE fkregistro IN (SELECT id FROM registro WHERE fkpersona LIKE '" + codigo + "') and estado LIKE '%" + filtro + "%'";
                        } else {
                            if (cbBuscarPersona.getSelectedIndex() == 6) {
                                sql = "SELECT id_activo, fkregistro, nombre, SUBSTRING(fecha, 1,10) AS fecha, marca, estado, color, material, accesorio, creador FROM activo WHERE fkregistro IN (SELECT id FROM registro WHERE fkpersona LIKE '" + codigo + "') and color LIKE '%" + filtro + "%'";
                            } else {
                                if (cbBuscarPersona.getSelectedIndex() == 7) {
                                    sql = "SELECT id_activo, fkregistro, nombre, SUBSTRING(fecha, 1,10) AS fecha, marca, estado, color, material, accesorio, creador FROM activo WHERE fkregistro IN (SELECT id FROM registro WHERE fkpersona LIKE '" + codigo + "') and material LIKE '%" + filtro + "%'";
                                } else {
                                    if (cbBuscarPersona.getSelectedIndex() == 8) {
                                        sql = "SELECT id_activo, fkregistro, nombre, SUBSTRING(fecha, 1,10) AS fecha, marca, estado, color, material, accesorio, creador FROM activo WHERE fkregistro IN (SELECT id FROM registro WHERE fkpersona LIKE ' " + codigo + "') and accesorio LIKE '%" + filtro + "%'";
                                    } else {
                                        if (cbBuscarPersona.getSelectedIndex() == 9) {
                                            sql = "SELECT id_activo, fkregistro, nombre, SUBSTRING(fecha, 1,10) AS fecha, marca, estado, color, material, accesorio, creador FROM activo WHERE fkregistro IN (SELECT id FROM registro WHERE fkpersona LIKE '" + codigo + "') and creador LIKE '%" + filtro + "%'";
                                        }
                                    }
                                }
                            }
    ...
    private void initComponents() {
        ...
        btnBuscarActivo1 = new javax.swing.JButton();
        ...
        cbBuscarPersona.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--Seleccionar--", "Codigo de activo", "Nombre", "Fecha", "Marca", "Estado", "Color", "Material", "Accesorio", "Codiigo creador de activo" }));
        ...
        btnBuscarActivo1.setBackground(new java.awt.Color(163, 177, 138));
        btnBuscarActivo1.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N
        btnBuscarActivo1.setText("BUSCAR");
        btnBuscarActivo1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnBuscarActivo1ActionPerformed(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(btnBuscarActivo1, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 90, 540, 280));
        ...
        cbBuscar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--Seleccionar--", "Codigo de activo", "Codigo de Registro", "Nombre", "Fecha", "Marca", "Estado", "Color", "Material", "Accesorio", "Codigo creador de activo" }));
        ...
        jButton3.setBackground(new java.awt.Color(163, 177, 138));
        jButton3.setText("LISTA DE ACTIVOS");
        ...
        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 660, 140));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 390, 1220, 390));

        jLabel1.setFont(new java.awt.Font("Open Sans", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(52, 78, 65));
        jLabel1.setText("Ver Registros de Activos");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 440, -1));
        ...
        txtNumeroRegistros.setEnabled(false);
        jPanel1.add(txtNumeroRegistros, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 360, 100, -1));
    ...
    private void btnVerActivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerActivoActionPerformed
        try {
            ...
            Logger.getLogger(verActivo.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//        me.setVisible(true);
    ...
    private void btnBuscarActivo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActivo1ActionPerformed
        buscarActivoPersona();
        contarRegistros();
    }//GEN-LAST:event_btnBuscarActivo1ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(verActivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton btnBuscarActivo1;
